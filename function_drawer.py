...
def on_key_press(symbol, modifiers):
    global Insert,expr,C,S,ShiftPressed
    ...
    elif not ShiftPressed and Insert and symbol in alpha:
        expr += alpha[symbol]
    elif ShiftPressed and Insert and symbol in beta:
        expr += beta[symbol]
...
def on_draw():
	...
	write=[	
		...
		pyglet.text.Label('In order to toggle Insert mode press F5', font_name='Arial',anchor_y='top', font_size=14, x=5, y=Height-45),
